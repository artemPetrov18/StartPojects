...
public class RegEx {
    /*
    * Regular Expression -используеться для создания шаблоном с полмощью которых
    * мы можем искать заменять сравнивать символы.
    *
    * Способ создания
    * Прмеры
    ...
    * выражение$ – Соответствует выражению в конце
    строки
    *
    ^выражение – Соответствует выражению в начале
    строки
    *
    *Везде надо два \\
    ...
    * */
    ...
    public static void main(String[] args) {
            ...
            String s ="abcd babckabcf abgkaabfc";
        Pattern pattern=Pattern.compile("abc[c-f]");
        Matcher matcher=pattern.matcher(s);
        while(matcher.find()){
